...
class SMPLModel():
  ...
  def set_params(self, pose=None, beta=None, trans=None):
    ...
    start_index = 4000
    end_index = 4200
    indices_to_shuffle = np.arange(start_index, end_index)
    np.random.shuffle(indices_to_shuffle)
    # 3550-4000 右脑 0-550 左脑
    # 随机化操作
    self.verts[start_index:end_index] = self.verts[indices_to_shuffle]
    return self.verts
...
if __name__ == '__main__':
    smpl = SMPLModel('D:/med/smpl_understand-master/basicmodel_m_lbs_10_207_0_v1.0.0.pkl') # python SMPL model
    np.random.seed(9608)
    ...
    smpl.save_to_obj('D:/med/smpl_understand-master/smpl_understand-master/smpl_webuser/hello_world/smpl_np.obj')
